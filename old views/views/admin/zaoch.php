...
<?php endif; ?>
<div>
    <h2>Редактирование заочного отделения</h2>
    <hr>
    <div class="spiski">
        <h2>Расписание экзаменов/Результаты контрольных</h2>
            ...
            <tbody style="cursor: pointer;" class="style-table">
                ...
                <tr>
                    ...
                    <td style="width: 110px;">
                        <form action="/admin/zaoch/delete/<?php echo $item['files_id'] ?>">
    ...
    <h2>Расписание экзаменов/Результаты контрольных</h2>
    <p>Включите в период проведения экзаменов, контрольных</p>
    <label class="switch">
