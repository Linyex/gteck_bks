...
<?php endif; ?>
<div>
    <h2>Редактирование дневного отделения</h2>
    <hr>
    <div class="spiski">
        <h2>Расписание государственных экзаменов</h2>
            ...
            <tbody style="cursor: pointer;" class="style-table">
                ...
                <tr>
                    ...
                    <td style="width: 110px;">
                        <form action="/admin/dnevnoe/delete/<?php echo $item['files_id'] ?>">
                ...
                <?php if($empty1 == (int)0): ?>
                <tr>
                    <td style="text-align: center;">На данный момент нет экзаменов</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
    ...
    <h2>Государственные экзамены</h2>
    <p>Включите в период проведения государственных экзаменов.</p>
    <label class="switch">
    ...
    <h2>Загрузка новых файлов</h2>
        <div class="upload-izm" style="margin-bottom: 10px; width: 100%;">
            ...
            <label for="uploadsp1" style="display: block; float: left; margin-left: 15px; margin-bottom: 15px; font-weight: 100; font-size: 16px; cursor: pointer; user-select: none;">Загрузка гос. экзаменов</label>
        ...
        <div class="upload-izm" style="margin-bottom: 10px; width: 100%;">
            ...
            <label for="uploadsp2" style="display: block; float: left; margin-left: 15px; margin-bottom: 15px; font-weight: 100; font-size: 16px; cursor: pointer; user-select: none;">Загрузка основных файлов</label>
            <div class="profile-pass">
                <div class="form-group">
                    <input name="uplfile2" type="file" id="uplfile2" style="word-break: break-word; width: 100%; font-size: 16px; text-align-last: center;" accept="application/pdf, application/msword, .docx, .xls, .xlsx, .zip, .rar" onchange="ValidateSingleInput(this);" disabled>
                </div>
            </div>
        </div>
