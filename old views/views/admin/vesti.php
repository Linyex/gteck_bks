...
<?php endif; ?>
<div>
    <h2>Редактирование вестей колледжа</h2>
    <hr>
    <div class="spiski">
        <h2>Список вестей колледжа</h2>
            ...
            <tbody style="cursor: pointer;" class="style-table">
                ...
                <tr>
                    ...
                    <td style="width: 110px;">
                        <form action="/admin/vesti/delete/<?php echo $item['files_id'] ?>">
                ...
                <?php if($empty1 == (int)0): ?>
                <tr>
                    <td style="text-align: center;">На данный момент нет вестей</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
    ...
    <h2>Загрузка новых файлов</h2>
        <div class="upload-izm" style="margin-bottom: 10px; width: 100%;">
            ...
            <label for="uploadsp1" style="display: block; float: left; margin-left: 15px; margin-bottom: 15px; font-weight: 100; font-size: 16px; cursor: pointer; user-select: none;">Загрузка вестей</label>
