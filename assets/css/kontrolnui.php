...
<div style="display: table; width: 100%; word-break: break-word;">
    ...
    <div class="panel" style="margin-bottom: 10px;">
        <a class="collapsed" data-toggle="collapse" href="#cl" aria-expanded="false" style="color: #fff;">
            <div class="panel-heading" style="border: solid #c3c3c3 1px; font-size: 18px; font-weight: 800; background: rgb(64, 123, 154);">1-й курс</div>
        </a>
    ...
    <div class="panel" style="margin-bottom: 10px;">
        <a class="collapsed" data-toggle="collapse" href="#c2" style="color: #fff;">
            <div class="panel-heading" style="border: solid #c3c3c3 1px; font-size: 18px; font-weight: 800; background: rgb(64, 123, 154);">2-й курс</div>
        </a>
    ...
    <div class="panel" style="margin-bottom: 10px;">
        <a class="accordion-toggle collapsed" data-toggle="collapse" href="#c3" style="font-size: 18px; color: #fff;">
            <div class="panel-heading" style="border: solid #c3c3c3 1px; font-size: 18px; font-weight: 800; background: rgb(64, 123, 154);">3-й курс</div>
        </a>
