...
<?php endif; ?>
<div>
    <h2>Редактирование фотографий участников художественной самодеятельности</h2>
    <hr>
    <div class="spiski">
            ...
            <tbody style="cursor: pointer;" class="style-table">
                ...
                <tr>
                    ...
                    <td style="width: 110px;">
                        <form action="/admin/xydsamo/delete/<?php echo $item['images_id'] ?>">
